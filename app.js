...
app.get("/faq/produto/produto", (req, res) => {
    res.status(200).json({ dados: dados["FAQ"]["Gestao de Produtos"]["Produto"] });
});

app.get("/faq/produto/digital", (req, res) => {
    res.status(200).json({ dados: dados["FAQ"]["Gestao de Produtos"]["Produto Digital"] });
});

app.get("/faq/produto/servicos", (req, res) => {
    res.status(200).json({ dados: dados["FAQ"]["Gestao de Produtos"]["Produto de Servicos"] });
});
